...
with open(file_to_load) as election_data:
    ...
    # For each row in the CSV file.(starting on second row)
    for row in reader:
...
# I have iterated over all the rows in the csv file(all the votes)
...
#note have iterated through all the counties
